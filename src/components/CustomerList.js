...
const bgColor = props.bgColor === AppColors.gray?AppColors.gray:AppColors.blue_light
  return (
    ...
    <View style={Style.majorContainer}>
            ...
            <Text style={[Style.text,{width:width*0.25}]}>{t('customer')}</Text>
            ...
            <Text style={[Style.text_btm,{width:width*0.25,color:bgColor}]}>Gucci Sunglasses</Text>
            <Text  style={[Style.text_btm,{color:bgColor}]}>$12k</Text>
            <Text  style={[Style.text_btm,{color:bgColor}]}>167</Text>
            <TouchableOpacity style={{paddingTop:10}} onPress={()=>{props.handleNavigation()}}>
