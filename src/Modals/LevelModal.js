   ...
   <Portal>
    ...
    >
        ...
        />
          ...
          <Text  style={{fontFamily:'Outfit-Bold', fontSize:16, textTransform:'uppercase'}}>  {t('level')+ ' 5'} </Text>
     
          <Text style={{fontFamily:'Outfit-Bold', fontSize:16, textTransform:'uppercase'}}> {t('require')} </Text>
          </View>
       

        <Dialog.Content style={{marginTop:20}}>
            <Text style={{fontFamily:"Outfit-Light",fontSize:14}}>{t('des1')+'5 '+t('des2')}</Text>
        </Dialog.Content>
        ...
        >
          <Text style={[Style.google_btn_Text,{textTransform:'uppercase'}]}>{t('guide')}</Text>
        </TouchableOpacity>
        </Dialog.Actions>
    </Dialog>
   </Portal>
